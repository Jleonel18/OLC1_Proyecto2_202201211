...
export default class IncreDecre extends Instruccion{
    ...
    interpretar(arbol: Arbol, tabla: tablaSimbolo) {
        ...
        if (valor == null) return new Errores("SEMANTICO", "Variable no existente", this.linea, this.columna)
            ...
            if(valor.getTipo().getTipo() != tipoDato.ENTERO) return new Errores("SEMANTICO", "No se puede incrementar o decrementar una variable que no sea de tipo numero", this.linea, this.columna);
